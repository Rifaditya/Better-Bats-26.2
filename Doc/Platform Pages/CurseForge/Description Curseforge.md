...
Flocking Range: <strong>12 blocks</strong> ó Cohesion, alignment, and separation steer bats naturally without any designated leader.
</blockquote>
...
During the night, bats are dynamically attracted to bright artificial light sources. They break from their swarms to circle lanterns and torches using smooth curved approaches and vertical bobbing, simulating the hunting of insects attracted to the glow. Rather than getting stuck forever, they exhibit a natural "Moth Effect"ócircling for a brief period before getting bored and hopping to a new light source!
...
<strong>‚ö†Ô∏è Important: Config vs. In-Game GameRules</strong><br>
